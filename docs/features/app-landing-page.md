...
Before starting, you need to initialize Firebase in your project. From the [kmp-contest-starter-kit](https://github.com/KotlinFoundation/kmp-contest-starter-kit) monorepo, navigate to `Web/public/` — it contains the app landing page template.
