...
**Koko** is KMPStarterKit — a Kotlin Multiplatform + Compose Multiplatform boilerplate starter kit for
...
The full codebase is on GitHub: [KotlinFoundation/kmp-contest-starter-kit](https://github.com/KotlinFoundation/kmp-contest-starter-kit).
