...
const config = {
  ...
  url: 'https://kotlinfoundation.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/kmp-contest-starter-kit-documentation/',


  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'KotlinFoundation', // Usually your GitHub org/user name.
  projectName: 'kmp-contest-starter-kit-documentation', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          // Home link
          { href: 'https://github.com/KotlinFoundation/kmp-contest-starter-kit', label: 'Home', position: 'right' },
          // Docs link
          ...
          // Primary button
          {
            ...
            href: 'https://github.com/KotlinFoundation/kmp-contest-starter-kit',
            position: 'right',
